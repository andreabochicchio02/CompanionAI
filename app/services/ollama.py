...
def query_ollama_no_stream(prompt, model):
    ...
    try:
        ...
        utils.append_server_log("Error: Cannot connect to Ollama. Is it running?")
    except Exception as e:
        utils.append_server_log(f"Unexpected error: {e}")
    else:
        utils.append_server_log("Response generated and sent successfully (stream=False)")
...
def query_ollama_streaming(prompt, model):
    ...
    try:
        ...
        utils.append_server_log("Response generated and sent successfully (stream=True)")
...
def preload_model(model_name):
    ...
    try:
        ...
        utils.append_server_log(f"Failed to preload model '{model_name}': {e}")
    else:
        utils.append_server_log(f"Model {model_name} preload correctly")